document.addEventListener('DOMContentLoaded', () => {
    ...
    window.addEventListener('scroll', () => {
        ...
        const isOverDarkSection = (
            (scrollY > committeesSection.offsetTop - navHeight) ||
            (scrollY > itinerarySection.offsetTop - navHeight)
        );
        const isOverLightSection = (scrollY > letterSection.offsetTop - navHeight && scrollY < committeesSection.offsetTop - navHeight);
    ...
    createObserver(letterSection, (target) => { target.classList.add('is-visible'); }, 0.2); // Lowered threshold for mobile
